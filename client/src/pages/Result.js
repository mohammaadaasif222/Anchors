...
const Result = () => {
  ...
  return (
    <div className="sm:my-10 xs:my-10">
      <div className="w-full md:py-20 h-[359px]  bg-stone-950 justify-center items-center inline-flex">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 px-10 py-5 bg-stone-900 rounded-2xl">
          <div className="w-full flex-col justify-center items-start gap-5">
          ...
          <div className="w-full flex-col justify-start items-start gap-[11px] inline-flex">
            <div className="h-[50px] text-white text-md font-medium font-['Inter']">
            ...
            <div className="h-[120px] flex-col justify-start items-center gap-6 flex">
              <div className="justify-start items-center inline-flex">
                <div className="w-10 h-10 pl-[9.50px] pr-[9.41px] py-1 justify-center items-center flex">
                  <div className="w-[21.09px] h-8 flex-col justify-start items-start flex" />
                </div>
              ...
              <div className="h-12 px-6 py-[18px] bg-white rounded-[35px] justify-center items-center gap-2.5 inline-flex">
                <div className="text-neutral-900 self-center font-normal font-['Inter']">
                  Check How?
                </div>
              </div>
            </div>
      ...
      <div className="text-white sm:mt-20 xs:mt-36 text-center text-opacity-70 text-xl font-medium font-['Inter'] leading-7">
